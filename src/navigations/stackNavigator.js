    ...
    return (
        <Stack.Navigator >
            <Stack.Screen 
                ...
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Privacy Policy" />})}
            />
        </Stack.Navigator>
    )
}
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen 
                ...
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Terms of Service" />})}
            />
        </Stack.Navigator>
    )
}
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen 
                ...
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Return Policy" />})}
            />
        </Stack.Navigator>
    )
}
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen 
                name='Wishlist' 
                component={Wishlist}
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Wishlist" />})}
            />
        </Stack.Navigator>
    )
}
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen 
                ...
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Order History" />})}
            />
        </Stack.Navigator>
    )
}
    ...
    return (
        <Stack.Navigator>
            <Stack.Screen 
                name='Settings' 
                component={Settings}
                options={({ navigation  }) => ({headerTitle: () => <Header navigation={navigation} showNav={true} title="Settings" />})}
            />
        </Stack.Navigator>
    )
}
